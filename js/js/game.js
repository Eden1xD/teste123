...
function updatePlayers(players) {
    ...
    if (!elements.playersList) {
        console.warn('⚠️ #playersList não encontrado.');
        return;
    }
    ...
    if (!Array.isArray(players)) {
        console.warn('⚠️ Lista de jogadores inválida:', players);
        players = [];
    }
    ...
    if (players.length === 0) {
        ...
        elements.playersList.innerHTML = `
            <div class="players-empty">
                ...
                <span>Nenhum jogador na sala</span>
            </div>
        `;
    ...
    players.forEach(player => {
        ...
        // Identifica o próprio jogador
        if (player.id === socket.id) {

            article.classList.add('is-me');
        ...
        if (player.connected === false) {
            ...
            article.classList.add('is-offline');
        ...
        elements.playersList.appendChild(article);
